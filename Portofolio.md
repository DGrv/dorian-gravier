...
*   Quality control
 ...
 ![Picture](assets/excel-ic50_orig.jpg)
...
Example of kinetic data with 2 addition in DRC format. Curve fitting of the 2 additions, raw data kinetic graphic, IC50 exported in spreadsheet format, 1 compound per line. IC50 parameters calculated with R (compared with GraphPad Prism: identical).
 ...
 ![Picture](assets/0008s001-kineplate_orig.jpg)

Kinetic data with in background the ratio MaxMin or Max Background.

 ![Picture](assets/scatter-value-npa-ori-vs-crop-3_orig.jpg)
...
Comparison of data for 2 different Image analysis procedure (HCS). Vertical and Horizontal lines reprensent 1 to 4x the sd of the compound data. Usually used as a threshold for hit selection.
 ...
 ![Picture](assets/scatter-ar-cel-i-ori-vs-crop_orig.jpg)

 ![Picture](assets/hcdrc-scatter-pc-inhibition-per_orig.jpg)

Comparison of data for 2 Sessions (duplicates).

 ![Picture](assets/hm-all-same-legend.jpg)

Heatmap of n (number of rows) plates in 3 variables (columns).

 ![Picture](assets/20160720-pq-drc-ctg-2-summary-valuect-con_orig.jpg)

Evolution of quality control parameters through a screen.

 ![Picture](assets/20160325-pq-prs-1-scaplot-med-int-ia.jpg)
...
*   **Data mining**
 ...
 ![Picture](assets/polara_orig.jpg)

Schedule Graphics created with the analysis of the logfile from 1 robotic line.

 ![Picture](assets/cplibrary1_orig.jpg)

 ![Picture](assets/cplibrary2_orig.jpg)
...
Density graphic (histogram) from the intensity of each field (image) from a well. Permit to see if some fields differ from the majority as well as to get an idea of the intensity distribution in the images
 ...
 ![Picture](assets/flex2_orig.jpg)

 ![Picture](assets/flex1.jpg)
...
My report is not available since it will certainly contribute to a future scientific publication. However, the abstract and the bibliography used can be found [here](assets/d.gravier_2012_intership_konstanz_bats_insects.pdf). 
...
I learned alone how to use R to create nice and interesting graphs as well as performing several statistical tests and manipulating dataframes. Some examples are exposed below with some information voluntary hidden (essentialy with libraries ggplot2, plyr, scales, grid, reshape, FactoMineR and ggmap).
 ...
 ![Photo](assets/9513442_orig.jpg)

 ![Photo](assets/2958636_orig.jpg)

 ![Photo](assets/7268086_orig.jpg)

 ![Photo](assets/1013339_orig.jpg)

 ![Photo](assets/3133014_orig.jpg)

 ![Photo](assets/1284476_orig.jpg)

 ![Photo](assets/8988297_orig.jpg)

 ![Photo](assets/8450187.jpg)
...
In the second one, I wrote a review concerning the **monitoring of green tides on the Brittany coast** (France). This one is available [here](assets/gravier_-_2012_-_monitoring_of_green_tides_on_the_brittany_coasts_france.pdf).
...
33 colonies found, 6 convention signed with owners of colony. Results are available [here](assets/d.gravier_2011_intership_bats_results.pdf).
Example of organisation of a prospective week-end to find bats' roost, management of several volunteers : [pdf available](assets/dorian-gravier_example_we-prosp_2011.pdf).


Example of analyzes and resulting map.
Explanations:

*   Map 1 : _cf _[this pdf](assets/d.gravier_2011_intership_bats_map1_expla.pdf)
*   Map 2 : _cf _[Results of the internship report.](assets/d.gravier_2011_intership_bats_results.pdf)

 ![Photo](assets/104426.jpg)

 ![Photo](assets/330057.jpg)

**Communication:**


 ![Photo](assets/8474397_orig.jpg)

 ![Photo](assets/7784363.jpg)

 ![Photo](assets/9933958.jpg)
...
You can have an idea of the final report given to the [Regional Nature Parc of the Haute Vallée de Chevreuse](http://www.parc-naturel-chevreuse.fr/) here ([Part 1](assets/dorian-gravier_part-report_pnrhvc_2010_1.pdf) & [Part 2](assets/dorian-gravier_part-report_pnrhvc_2010_2.pdf)) with the map provided here.
...
Example of map created for the conservative plan. Those are concerning the ideas that we proposed on prioritize area for the species). 
 ...
 ![Photo](assets/620556.jpg)

 ![Photo](assets/9081003.jpg)

 ![Photo](assets/2842060.jpg)
...
This internship was quietly only field work. I had a certain area to prospect to find the maximum of lady-beetles species. First use of Arc gis by my own wishes. You can have a look to the [short results](assets/dorian-gravier_results_2009_atlas_ladybeetles.pdf).
...
Some other examples of graphic done with R (essentialy with libraries ggplot2, plyr, scales, grid, reshape, lattice and ggmap).
 ...
 ![Photo](assets/2088431_orig.jpg)

 ![Photo](assets/9484012_orig.jpeg)

 ![Photo](assets/3327157_orig.jpg)

 ![Photo](assets/6190964_orig.jpg)

 ![Photo](assets/9663466_orig.jpg)

 ![Photo](assets/228531_orig.jpeg)
