...
sesExtract () {
    if [ -f "$1" ]; then
        ...
        /mnt/c/Windows/System32/cmd.exe /C "C:\Users\doria\scoop\shims\rscript.exe" "C:\Users\doria\Downloads\GitHub\dorian.gravier.github.io\files\RR\Leaflet_v02.R" "$PWD/$fdir"
        cecho -g Done
    else
        echo File not found
    fi
