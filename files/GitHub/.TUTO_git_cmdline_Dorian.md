...
cd rrst_website
git init
gh repo create rrst_website ^
  --description "Test Website for rrst" ^
  --homepage "https://github.com/DGrv/rrst_website" ^
  --public ^
  --source=. ^
  --remote=origin

# Create a README or any file
echo "# rrst_website" > README.md
git add README.md && git commit -m "Initial commit" && git push -u origin main
git push --set-upstream origin main
REM changes in private
gh repo edit DGrv/rrst_website --accept-visibility-change-consequences --visibility private
REM NEED to be public for github pages for normal users

:: rename a Branch (where you are on)
git branch -M main
