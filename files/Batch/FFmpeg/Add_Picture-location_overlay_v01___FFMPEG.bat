...
ffmpeg -stats -loglevel error -i "%filenamenew%" -i "D:\Pictures\GoPro\Map_bike\Location_choose_white.png" -filter_complex "[1:v]setpts=PTS-STARTPTS+(1/TB)[1v];[0:v][1v] overlay=%position%:enable='between(t,%times%)'" -c:a copy "%filename%"
