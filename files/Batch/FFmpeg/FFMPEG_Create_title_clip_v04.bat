...
ffmpeg -stats -loglevel error -i Title_new.mp4 -f lavfi -i anullsrc=channel_layout=stereo:sample_rate=48000 -video_track_timescale 24000 -shortest -y "%title1%.mp4"
del Title_new.mp4
