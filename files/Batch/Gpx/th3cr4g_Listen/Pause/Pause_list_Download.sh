...
# curl  \
  ...
  # -H 'sec-ch-ua-platform: "Windows"' "https://www.thecrag.com/de/liste/9351367707" > MainList.html
# xmllint --noout  --html --xpath "//div[@class='titlelist']/span/a/@href" MainList.html | perl -pe "s| href=\"(.*)\"|https://www.thecrag.com\1|g" > Urls.txt

# echo "urlroute;url;name;grad;lat;lon" > output.csv
...
do
  ...
  then
    ...
    if [ "$loc" != "" ]
    then
      echo "$line;$arealink;$nameroute;$grad;$loc" >> output.csv
    fi
