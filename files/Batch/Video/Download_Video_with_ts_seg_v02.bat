...
FOR /L %%p IN (1, 1, 2000) DO (
	set p2=00000%%p
    set p2=!p2:~-5!
	echo wget --no-check-certificate --user-agent Mozilla/4.0 "%dirname%/seg-%%p-v1-a1.ts" -O "!p2!.ts" -o log
	wget --no-check-certificate --user-agent Mozilla/4.0 "%dirname%/seg-%%p-v1-a1.ts" -O "!p2!.ts" -o log
