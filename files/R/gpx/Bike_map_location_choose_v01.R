...
#   geom_path(data=data3, aes(lon, lat), color = cc2[1], size = 1.2)+
...
a <- ggplot()+
  geom_polygon(data=world, aes(long, lat, group = group), colour='white', fill="gray80", size=1.25)+
  geom_path(data=data3, aes(lon, lat), color = cc[1], size = 1.2)+
...
system('magick Location_choose_white.png -fill "rgba(204,204,204,0.2)" -opaque rgba(204,204,204)  Location_choose_white.png')
