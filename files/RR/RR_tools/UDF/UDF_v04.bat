...
C:\Users\doria\scoop\apps\git\current\usr\bin\rm.exe UDF_ori_filtered.json UDF_from-template.json UDF_ori.csv UDF_ori_filtered.csv temp.lvs UDF_gdrive.csv *.stats.csv.* *.stats.csv UDF_compare_event.csv UDF_compare_gdrive.csv UDF_compare_gdrive_temp.csv 
