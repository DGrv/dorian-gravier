...
func ShowArray(arrayname)
    t="0"
    for i in 0..((arrayname | array.Size) -1)
        a=(arrayname[i][1]//1)+""
        t=t+"-"+a
    end
    t
...
func RuntimeTrail(EvDate, T0, withMinus)
...
func multilines(userstring)
	# you need to have iput string with "\n"
	userstring | string.split "\\n"  | array.Join "\n" 
end


# ---------------------------------------------

func RuntimeStringNEW(Start)
